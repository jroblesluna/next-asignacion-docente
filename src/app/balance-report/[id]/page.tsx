          ...
          <tbody>
            <tr className="text-xs border">
              ...
              <td className="text-center border">
                {balanceData.filter((rowBalance) => rowBalance.statusTeacher === 'FT').length}
              </td>
              ...
              {locationData.map((item, index) => (
                <td className="text-center border font-bold " key={index}>
                  {(
                    (balanceData.filter((rowBalance) => rowBalance.location === item).length /
                      3 /
            ...
            <tr className="text-xs border">
              ...
              <td className="text-center border">
                {balanceData.filter((rowBalance) => rowBalance.statusTeacher === 'PT').length}
              </td>
              {locationData.map((item, index) => (
                <td className="text-center border" key={index}>
                  {
                ...
                <td key={item} className="text-center border">
                  {(
                    balanceData
                      ...
                      .reduce((acumulador, rowBalance) => acumulador + rowBalance.points, 0) /
                    (balanceData.filter((rowBalance) => rowBalance.location === item).length /
                      3)
                  ).toFixed(2)}
                </td>
